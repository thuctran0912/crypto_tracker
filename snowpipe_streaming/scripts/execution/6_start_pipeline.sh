...
python3 $HOME/snowpipe-streaming/scripts/websocket_client/websocket_to_kafka.py | $HOME/snowpipe-streaming/kafka_2.12-2.8.1/bin/kafka-console-producer.sh --broker-list $BS --producer.config $HOME/snowpipe-streaming/scripts/client.properties --topic trade_streaming